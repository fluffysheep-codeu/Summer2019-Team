...
import ExamplePage from 'components/page/ExamplePage.js';
import { ABOUT_US, HOME, USER_PAGE, EXAMPLE_PAGE } from 'constants/links.js';
      ...
      <BrowserRouter>
        <div className='App'>
          ...
          <Switch>
            ...
            <Route exact path={EXAMPLE_PAGE} component={ExamplePage} />
          </Switch>
        </div>
      </BrowserRouter>
    );
